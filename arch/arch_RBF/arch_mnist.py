...
class ARCH_mnist():
	...
	def generator_model_aedense_mnist(self):
		...
		enc3 = tf.keras.layers.Dense(256, kernel_initializer=init_fn, use_bias = True, bias_initializer = bias_init_fn)(inputs)
	...
	def discriminator_model_aedense_mnist(self):
		init_fn = tf.keras.initializers.glorot_uniform()
		init_fn = tf.function(init_fn, autograph=False)
