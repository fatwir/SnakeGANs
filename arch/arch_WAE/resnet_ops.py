...
# def spectral_conv2d(x, filters, kernel_size, stride, padding='SAME', use_bias=True):
...
#                          padding=padding)
#         if use_bias:
#             bias = tf.compat.v1.get_variable("conv_bias", [filters], initializer=tf.constant_initializer(0.0))
...
#     f = spectral_conv2d(x, filters // 8, kernel_size=1, stride=1)  # [bs, h, w, c']
#     g = spectral_conv2d(x, filters // 8, kernel_size=1, stride=1, padding='VALID')  # [bs, h, w, c']
#     h = spectral_conv2d(x, filters, kernel_size=1, stride=1, padding='VALID')  # [bs, h, w, c]
