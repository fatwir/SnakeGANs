...
class ARCH_lsun():
	...
	def __init__(self):
		print("CREATING ARCH_AAE for LSUN CLASS")
		return

	def encdec_model_dcgan_lsun(self):
	...
	def discriminator_model_dcgan_lsun(self):
	...
	def show_result_lsun(self, images=None, num_epoch=0, show = False, save = False, path = 'result.png'):
