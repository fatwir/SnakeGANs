...
class ARCH_ffhq():
	...
	def __init__(self):
		...
		return
	def encdec_model_deepdcgan_ffhq(self):
	...
	def discriminator_model_deepdcgan_ffhq(self):
	...
	def encdec_model_dcgan_ffhq(self):
	...
	def discriminator_model_dcgan_ffhq(self):
		init_fn = tf.keras.initializers.glorot_uniform()
		init_fn = tf.function(init_fn, autograph=False)
